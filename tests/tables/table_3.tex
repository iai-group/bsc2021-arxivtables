    ...
    \begin{center}
        \begin{tabular}{l|c|c}
           % \hline
            ...
            $r(y_1) \leq \ell(y_2)$ & $\begin{array}{c}(+1,0) \to (+1,0) \\ (0,-1) \to (+1,0)\end{array}$   & $\begin{array}{c}(+1,0) \to (+1,0) \\ (0,-1) \to (0,-1)\end{array}$ \\ \hline
            $r(y_1) > \ell(y_2)$ & $\begin{array}{c}(+1,0) \to (+1,0) \\ (0,-1) \to (0,-1)\end{array}$   & $\begin{array}{c}(+1,0) \to (0,-1) \\ (0,-1) \to (0,-1)\end{array}$ \\ %\hline
        \end{tabular}
    \end{center}
    \caption{
